-- Pärast püsivate Auth-kontode lisamist ei tohi administraatoriõigus sõltuda kuvatavast nimest.
-- Olemasolev administraator säilitab oma rolli; kõik uued ühise koodiga liitujad on tavaliikmed.
...
begin
  ...
  -- Täiesti tühja projekti esimene kontrollitud algkäivitus jääb alles.
...
revoke all on function public.redeem_group_code(text,text) from public, anon;
