-- Uue tühja projekti ühekordne algkäivitus. Turvakood salvestatakse ainult bcrypt-räsina.
...
create trigger set_updated_at before update on public.app_bootstrap
for each row execute function public.set_updated_at();

alter table public.app_bootstrap enable row level security;
-- Sellele tabelile ei looda kliendipoliitikaid: seda kasutab ainult security definer RPC.
