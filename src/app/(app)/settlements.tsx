...
const makeStyles = (colors: ThemeColors) => StyleSheet.create({
  summaryCard: { gap: 13 }, summaryTitle: { color: colors.ink, fontSize: 21, fontWeight: '700' }, summaryTotals: { flexDirection: 'row', flexWrap: 'wrap', gap: 10 }, summaryStat: { flexGrow: 1, flexBasis: 150, minWidth: 0, borderRadius: 9, borderWidth: 1, borderColor: colors.border, padding: 13, backgroundColor: colors.subtle }, summaryLabel: { color: colors.muted, fontSize: 14, fontWeight: '600' }, summaryAmount: { color: colors.ink, fontSize: 23, fontWeight: '700', marginTop: 4 }, summaryRow: { minWidth: 0, flexDirection: 'row', alignItems: 'center', gap: 12, borderTopWidth: 1, borderTopColor: colors.border, paddingTop: 12 }, summaryParty: { color: colors.ink, fontSize: 16, lineHeight: 22, fontWeight: '700' }, summaryCount: { color: colors.muted, fontSize: 14, marginTop: 2 }, summaryRowAmount: { color: colors.ink, fontSize: 18, fontWeight: '700' },
  section: { gap: 12 }, sectionTitle: { color: colors.ink, fontSize: 20, fontWeight: '700', marginTop: 4 }, emptyLine: { color: colors.muted, fontSize: 16, lineHeight: 23, paddingVertical: 4 },
  cardTop: { flexDirection: 'row', alignItems: 'flex-start', gap: 12, flexWrap: 'wrap' }, amount: { color: colors.ink, fontSize: 25, fontWeight: '700' }, party: { color: colors.muted, fontSize: 15, lineHeight: 21, marginTop: 3 }, description: { color: colors.ink, fontSize: 17, lineHeight: 24 },
  badge: { backgroundColor: colors.dangerSoft, borderRadius: 7, paddingHorizontal: 9, paddingVertical: 6 }, badgePaid: { backgroundColor: colors.primarySoft }, badgeWaiting: { backgroundColor: colors.accentSoft }, badgeCancelled: { backgroundColor: colors.subtle }, badgeText: { color: colors.ink, fontSize: 13, fontWeight: '600' },
  listLink: { minHeight: 44, justifyContent: 'center', alignSelf: 'flex-start' }, listLinkText: { color: colors.primary, fontSize: 15, fontWeight: '700' },
  label: { color: colors.ink, fontSize: 15, fontWeight: '600' }, options: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 }, option: { minHeight: 44, borderRadius: 8, borderWidth: 1, borderColor: colors.fieldBorder, backgroundColor: colors.field, paddingHorizontal: 14, paddingVertical: 10, justifyContent: 'center' }, optionActive: { backgroundColor: colors.primarySoft, borderColor: colors.secondaryBorder }, optionText: { color: colors.ink, fontSize: 15, fontWeight: '600' }, optionTextActive: { color: colors.primaryDark, fontWeight: '700' }, error: { color: colors.danger, fontSize: 16, lineHeight: 22 },
});
