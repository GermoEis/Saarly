...
const makeStyles = (colors: ThemeColors) => StyleSheet.create({ head: { flexDirection: 'row', alignItems: 'center', gap: 9 }, title: { color: colors.ink, fontWeight: '800', fontSize: 20, letterSpacing: -.2 }, count: { backgroundColor: colors.primarySoft, color: colors.primaryDark, fontWeight: '900', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 99, overflow: 'hidden' }, assignedBlock: { gap: 8 }, actions: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, paddingHorizontal: 4 }, deliveryCard: { flexDirection: 'row', alignItems: 'center', flexWrap: 'wrap', gap: 13, backgroundColor: colors.accentSoft, borderColor: colors.accentBorder }, deliveryIcon: { width: 48, height: 48, borderRadius: 15, backgroundColor: colors.surface, alignItems: 'center', justifyContent: 'center' }, deliveryCopy: { flex: 1, minWidth: 210 }, deliveryTitle: { color: colors.ink, fontSize: 19, fontWeight: '800', letterSpacing: -.2 }, deliveryText: { color: colors.muted, fontSize: 15, lineHeight: 22, marginTop: 3 } });
