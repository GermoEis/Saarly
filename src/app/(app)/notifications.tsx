...
const makeStyles = (colors: ThemeColors) => StyleSheet.create({ unread: { borderColor: colors.unreadBorder, backgroundColor: colors.unreadSurface }, row: { flexDirection: 'row', alignItems: 'flex-start', gap: 12 }, dot: { width: 8, height: 8, borderRadius: 4, backgroundColor: colors.primary, marginTop: 7 }, dotRead: { width: 8, height: 8, borderRadius: 4, backgroundColor: colors.border, marginTop: 7 }, title: { color: colors.ink, fontSize: 17, lineHeight: 22, fontWeight: '700', letterSpacing: -.1 }, body: { color: colors.muted, fontSize: 16, lineHeight: 23, marginTop: 4 }, time: { color: colors.timestamp, fontSize: 13, lineHeight: 18, marginTop: 10 }, arrow: { width: 28, height: 28, alignItems: 'center', justifyContent: 'center', marginTop: -1 } });
