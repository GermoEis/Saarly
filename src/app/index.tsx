...
const makeStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  logo: { width: 72, height: 72, borderRadius: 22, backgroundColor: colors.primary, alignItems: 'center', justifyContent: 'center', transform: [{ rotate: '-4deg' }] },
  logoText: { color: colors.onPrimary, fontSize: 41, fontWeight: '900' },
  name: { fontSize: 36, color: colors.ink, fontWeight: '900', marginTop: 10 },
  tagline: { fontSize: 17, color: colors.muted, textAlign: 'center', lineHeight: 25 },
  panel: { width: '100%', maxWidth: 540, borderWidth: 1, borderColor: colors.border, borderRadius: 24, backgroundColor: colors.surface, padding: 24, gap: 17, boxShadow: '0 12px 38px rgba(0, 0, 0, .16)' },
  switchRow: { flexDirection: 'row', gap: 8, backgroundColor: colors.subtle, borderRadius: 14, padding: 4 },
  switchButton: { flex: 1, minHeight: 46, alignItems: 'center', justifyContent: 'center', borderRadius: 11 },
  ...
  choiceBlock: { gap: 13, borderWidth: 1, borderColor: colors.border, borderRadius: 16, padding: 16, backgroundColor: colors.subtle },
  choiceTitle: { fontSize: 19, fontWeight: '900', color: colors.ink },
  ...
  users: { gap: 10 },
  user: { minHeight: 72, flexDirection: 'row', alignItems: 'center', gap: 13, backgroundColor: colors.subtle, borderRadius: 15, padding: 10, borderWidth: 1, borderColor: colors.border },
